...
import com.TopLabBazaar2909.TLBnew2909.Enum.Status;
...
public class RoleServiceImpl implements RoleService {
    ...
    public RoleDTO createRole(RoleDTO roleDTO) {
        ...
        com.TopLabBazaar2909.TLBnew2909.entity.Status statusEntity;
...
//    }
    ...
    public Role22 deactivateRole(String roleId) {
        ...
        if (optionalRole.isPresent()) {
            ...
            com.TopLabBazaar2909.TLBnew2909.entity.Status inactiveStatus = statusRepository.findByName("INACTIVE")
